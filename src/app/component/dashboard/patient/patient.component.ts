...
export class PatientComponent implements OnInit {
  ...
  allPatients : Patient[] = [];
  allDoctors : Doctor[] = [];
  displayedColumns: string[] = ['name', 'mobile', 'doctor', 'gender','Blood Type','action'];
  ...
  findPatient(){
    ...
    dialogConfig.data = {
      title : 'Find Patient',
      buttonName : 'ScanPrint'
    }

    const dialogRef = this.dialog.open(FindPatientComponent, dialogConfig);
